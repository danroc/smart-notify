...
def strategy_selector() -> selector.SelectSelector:
...
def level_selector() -> selector.SelectSelector:
...
def log_level_selector() -> selector.SelectSelector:
...
def tolerance_selector() -> selector.NumberSelector:
...
def duration_selector() -> selector.TextSelector:
    """Return the expire-after duration text selector."""
    return selector.TextSelector()


def person_selector() -> selector.EntitySelector:
...
def notify_selector() -> selector.EntitySelector:
...
def arrival_debounce_selector() -> selector.NumberSelector:
